...
\subsections{The Akra-Abzzi method}
...
But first of all, we have to determine the problem carefully in which sense it should be optimal. During my studies I heared of some theorems which determine an easy solution to this optimality problem.
For example there is this very powerfull theorem names Akra-Bazi.
 It is a general solution for linar devide-and-conquer correctnes of the form
 
 \begin{equation}
 u_n = \sum_{i}^k a_i u _{\frac{n}{b_i}} + g(n).
 \end{equation}
