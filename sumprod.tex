...
\begin{itemize}
%
\item Sei $a_i = a$ für $1 \le k \le n$, dann gilt $\sum\limits_{i=1}^n a_i =
...
\item $\sum\limits_{i=1}^n (a_i + b_i + c_i + \dots) =
  ...
  \sum\limits_{i=1}^n c_i + \dots$ (Addition von Summen gleicher Länge).
%
...
\begin{itemize}
%
\item Sei $a_i = a$ für $1 \le k \le n$, dann gilt $\prod\limits_{i=1}^n a_i =
...
%
\item $\prod\limits_{i=m}^n a_i = \prod\limits_{i=l}^{n} a_{i+m-l}$
  und $\prod\limits_{i=1}^n a_i = \prod\limits_{i=l}^{n-m+l} a_{k+m-l}$
