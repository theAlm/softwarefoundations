...
\fi
\section{Einige Grundlagen von formale Beweistechniken}
...
Steuerung von Raumsonden) gefährden solche Fehler menschliches Leben
...
Kugeln (in Abhängigkeit von der Höhe) in einer solchen Pyramide
gestapelt sind.
...
ersten Schritt ($=$ Induktionsanfang) die "`atomaren"' Objekte
definiert und dann in einem zweiten Schritt die zusammengesetzten
Objekte ($=$ Induktionsschritt). Diese Technik ist
als \emph{induktive Definition} bekannt.
