...
Der Schubfachschluss ist auch als \emph{Dirichlets
Taubenschlagprinzip} bekannt. Werden $k > n$ Tauben auf $n$ Boxen
...
\emph{Induktionsschritt}. Die Voraussetzung ($\triangleq$ Hypothese)
$E(k)$ ist korrekt für $k \le n$, die im Induktionsschritt benutzt
wird, wird auch \emph{Induktionsvoraussetzung}
...
Technik ist als \emph{induktive Definition} bekannt.
