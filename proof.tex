...
\emph{Induktionsschritt}. Die Voraussetzung ($=$ Hypothese) $E(k)$ ist korrekt für $k \le n$, 
die im Induktionsschritt benutzt wird, wird auch \emph{Induktionsvoraussetzung} 
(kurz \textbf{\textsf{IV}}) genannt.
