...
\emph{Induktionsschritt}. Die Voraussetzung ($=$ Hypothese) $E(n)$, die im
Induktionsschritt benutzt wird, wird
auch \emph{Induktionsvoraussetzung} (kurz \textbf{\textsf{IV}}) genannt.
...
{Eine Pyramide der Höhe $n = 1$ enthält $\frac{1 \cdot 2 \cdot 3}{6} =
  1$ Kugeln. D.h.~wir haben die Eigenschaft für $n = 1$ verifiziert.}%
