...
\dindex{Aussagenvariablen} ausgedrückt, die nur die Werte $0$ oder $1$
...
gleich $m$ und $m$ kleiner gleich $n$ gilt, dann ist $m$ gleich $n$"'y
\begin{displaymath}
...
\begin{displaymath}
\forall n\in\N\, \nexists a,b,c \in \N \colon ((n > 2) \simpl a^n + b^n
= c^n)  
\end{displaymath}
Für den Fall $n=2$ hat die Gleichung $a^n + b^n
= c^n$ ganzzahlige Lösungen (vgl.~Pythagoräische Zahlentripel) wie z.B.~$3^2+4^2=5^2$.
\end{example}
