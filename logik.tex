...
x \colon P(x)$ vereinfachend $\forall x P(x)$. Die Aussageform $P(x)$ wird auch als Prädikat (siehe Definition \ref{def:praedikat} auf Seite \pageref{def:praedikat}) bezeichnet, weshalb man von \dindex{Prädikatenlogik}\index{Logik!Prädikat} spricht.
