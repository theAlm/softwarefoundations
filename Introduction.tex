...
\paragraph{Coquille}
Coqille is a vim plugin used by the author it can be found here \url{https://github.com/Werner2005/coquille}.
...
Coquille labels itself as a user friendly  replacement to Coqtop. 
It provides forwards and backwards navigation. \\

In order to launch it start gvim or vim from the console an run (\texttt{:CoqLaunch}). 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Furthermore, it highlights the syntax. 
%TODO: explain syntax highlithing.  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
