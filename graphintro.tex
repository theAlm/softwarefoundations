...
\begin{figure}
\centering
\subfloat[Ein grober Stadtplan]{\includegraphics[scale=0.5]{BrueckenProb.eps}}
\hspace*{2em}
\subfloat[Der formalisierte Stadtplan]{\includegraphics[scale=0.8]{BrueckenProb2.eps}}
