...
\begin{figure}
\centering
\subfloat[Ein grober Stadtplan]{\includegraphics[scale=0.6]{BrueckenProb.eps}}
\hspace*{2em}
\subfloat[Der formalisierte Stadtplan]{\includegraphics[scale=0.9]{BrueckenProb2.eps}}
