...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	   ...
	   \end{definition}
	    ...
	    A more detailed approach of understanding the tactics \lstinline!refelxivity! is elaborated in section \ref{sec:reflexivity}.  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	   ...
	   \end{lstlisting}
		...
		\begin{example}[First \lstinline!destruct!] ~\\\vspace{-10mm}
