 ...
 One might picture this representation by strokes on the coffe consumation list of the DOPSY group staff members.  
  ...
  \end{lstlisting}
   ...
   \begin{example}
    ...
    \subparagraph{Intros, Simplification and Reflexivity}
     ...
     The suffix \lstinline!_l! is pronounced ``on the left'' (see listing \ref{exp:reflexivity}). 
	 \begin{lstlisting}[caption = \lstinline!mult_0_l!, label= {exp:reflexivity}]
   ...
   Due to the \href{https://pjreddie.com/coq-tactics/}{Coq tactics index} it is recommended to use reflexivity, if your goal is to prove that something is equals to itself.  
     ...
     \subparagraph{Proof by Rewriting}
