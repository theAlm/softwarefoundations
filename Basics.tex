...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%     The {\itshape tactic} \lstinline! intros!.        
         ...
         \begin{table}[h]       
	         ...
	         \end{center}          
          \end{table}  
       N	ote that the syntax and semantics of the Coq-code in listing \ref{lst:plus_id_example} can be easily understood by a reader who is familiar with the notation of predicate logic as in \ref{BasisLogik}. 
