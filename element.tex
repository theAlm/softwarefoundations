...
Als Potenzmenge der Menge $A$ ergibt sich die Menge von Mengen
$\PowerSet{A} = \set{\emptyset,\allowbreak \set{2},\allowbreak \set{3},
...
\set{2,3,7},\set{2,5,7}, \allowbreak \set{3,5,7},\set{2,3,5,7}}$. 
...
\begin{itemize}
%
\item Der \dindex{Definitionsbereich} der Funktion $f$ ist $D_f \eqd
\set{a \colon \text{es existiert ein $b$ mit $f(a) = b$}}$.
%
\item Der \dindex{Wertebereich} der Funktion $f$ ist $W_f \eqd
\set{b \colon \text{es existiert ein $a$ mit $f(a) = b$}}$.
%
\item Die Funktion $f \colon A \rightarrow B$ ist \dindex{total} \iffd $D_f
= A$.
% 
\item Die Funktion $f \colon A \rightarrow B$ heißt \dindex{surjektiv} \iffd $W_f = B$.
%
\item Die Funktion $f$ heißt \dindex{injektiv} (oder eineindeutig) \iffd
\ immer wenn $f(a_1) = f(a_2)$ gilt auch $a_1 = a_2$.
%
\item Die Funktion $f$ heißt \dindex{bijektiv} \iffd $f$ ist injektiv und surjektiv.
\end{itemize}
\end{definition}
