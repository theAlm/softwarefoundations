...
%
\item Eine Funktion $f \colon A \rightarrow B$ ist \emph{total} \iffd $D_f
= A$.
% 
\item Eine Funktion $f \colon A \rightarrow B$ heißt \emph{surjektiv} \iffd $W_f = B$.
%
...
heißt \emph{Permutation}. Das bedeutet, dass die Funktion $\pi$ Elemente aus $S$
