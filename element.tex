...
\set{5}, \set{7}, \set{2,3}, \set{2,5}, \allowbreak \set{2,7}, \allowbreak \set{3,5}, 
\allowbreak \set{3,7}, \allowbreak \set{5,7}, \set{2,3,5},
\set{2,3,7}, \allowbreak \set{2,5,7}, \allowbreak \set{3,5,7}, 
\allowbreak \set{2,3,5,7}}$.  
\end{example}
\end{definition}

\ifpdf
\special{pdf: out 4 << /Title 
(Gesetze für Mengenoperationen) /Dest [ @thispage /FitH @ypos ] >>}
\fi
...
x \rceil \eqd \text{die kleinste ganze Zahl, die größer oder gleich
