...
die Abkürzung \gdw\index{gdw.} um Schreibarbeit zu sparen.
...
\end{array}
\end{displaymath}
Die "`de-Morganschen Regeln"' wurden nach ihrem Erfinder \textsc{Augustus De
Morgan}\footnote{*$1806$ in Madurai, Tamil Nadu, Indien - $\dag$$1871$
in London, England} benannt.
...
%
\item Die Funktion $f$ heißt \dindex{injektiv} (oder eineindeutig) \gdw
...
ganze  Zahl, die größer oder gleich $x$ ist}\ (\triangleq
\text{"`Aufrunden"'}).
\end{displaymath}
