...
\begin{itemize}
%
\item heißt $R$ \dindex{Halbordnung} \gdw $R$ ist reflexiv,
antisymmetrisch und transitiv,
%
\item \dindex{Ordnung} \gdw $R$ ist eine lineare Halbordnung und
%
\item \emph{Äquivalenzrelation}\index{Aquivalenzrelation=Äquivalenzrelation} 
...
Aufgrund der Monotonieeigenschaft eines Hüllenoperators kann man bei der Abgeschlossenheit die Eigenschaft $\Psi(\Psi(A)) = \Psi(A)$ auch durch $\Psi(\Psi(A)) \subseteq \Psi(A)$ ersetzen. In der Informatik spielen Hüllenoperatoren eine große Rolle. Gute Beispiele hierfür sind z.B.~die \dindex{transitive Hülle} (vgl.~Computergraphik), die Kleene-Hülle (vgl.~Formale Sprachen) oder der Abschluss einer Komplexitätsklasse unter Schnitt oder Vereinigung. 
