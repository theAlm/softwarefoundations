...
Verküpfung zwischen den Elementen dieser Mengen. Dann definieren wir
\begin{displaymath}
A \odot B \eqd \set{a \odot b \mid a \in A \text{ und } b \in A}.
\end{displaymath}
...
$(a, b) \in f$. Ist also $(a,b) \in f$, so schreibt man $f(a) = b$.
...
\set{a \mid \text{es existiert ein $b$ mit $f(a) = b$}}$.
%
\item Der \dindex{Wertebereich} der Funktion $f$ ist $W_f \eqd
\set{b \mid \text{es existiert ein $a$ mit $f(a) = b$}}$.
%
